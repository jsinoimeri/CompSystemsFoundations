...
Message1: .DB	'Enter a signed dec num (up to +/-31): $'		; Message to be printed on screen
Message2: .DB 'In quarter precision IEEE-754: $'
		
;;;;;;;;;;;;;
; Main function: Asks the user to enter a signed number between -31 to +31
