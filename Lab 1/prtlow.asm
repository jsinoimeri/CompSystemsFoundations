...
;
	...
	cmp AL, 'z' ; is the character a 'z'
	
	JA incPtr ; if it is above, then jump to incPtr
	
	cmp AL, 'a' ; is the character a 'a'
	
	JAE outPtr ; if it is above or equal then jump to outPtr

	JB incPtr  ; if it is below then jump to incPtr
